---
name: New Reform Idea
about: Submit a new healthcare reform idea
title: '[IDEA] '
labels: ['new-idea']
assignees: []
...
## Idea Title
<!-- Provide a clear, concise name for your reform idea -->

## Category
<!-- Select one or suggest a new one -->
- [ ] Drug Pricing
- [ ] Insurance
...
## The Problem
<!-- Describe the specific problem in the healthcare system this addresses -->
...
<!-- What are the downsides, obstacles, or political barriers? -->
- 
- 

## Implementation Path
<!-- What are the concrete steps to make this happen? -->
- [ ] Step 1: 
- [ ] Step 2: 
- [ ] Step 3: 

## Related Ideas
<!-- Link to any similar ideas already in this repository -->
